...
17. Non-reasoning output is unaffected: user input and plain-text responses render as they do today, and reasoning is the only content rendered as a collapsible thinking block.
## Non-goals
